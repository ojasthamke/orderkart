                  ...
                  GridView.count(
                    ...
                    children: [
                      ...
                      _actionCard(
                        ...
                        color: Colors.green,
                        onTap: () => Navigator.pushNamed(
                            context, AppRoutes.groceriesHub),
                        index: 8,
                      ),
                      _actionCard(
                        context,
                        ...
                        color: Colors.teal,
                        onTap: () => Navigator.pushNamed(
                            context, AppRoutes.medicinesHub),
                        index: 9,
                      ),
                      _actionCard(
                        context,
                        ...
                        color: Colors.pink,
                        onTap: () => Navigator.pushNamed(
                            context, AppRoutes.catalogShowroom),
                        index: 10,
                      ),
                    ],
                  ),
                  const SizedBox(height: 28),
                  const Text("Today's Performance Metrics",
                      style:
                          TextStyle(fontSize: 16, fontWeight: FontWeight.w800)),
                  const SizedBox(height: 12),
                  commissionAsync.when(
                    ...
                    data: (comm) {
                      ...
                      return reportAsync.when(
                        ...
                        data: (rpt) {
                          final pendingDues =
                              (rpt['pending_amount'] as num?)?.toDouble() ??
                                  0.0;
                                ...
                                children: [
                                  Expanded(
                                    child: StatCard(
                                      ...
                                      value:
                                          AppFormatters.currency(todayEarning),
