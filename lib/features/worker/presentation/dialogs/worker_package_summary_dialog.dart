...
class WorkerPackageSummaryDialog extends StatelessWidget {
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: isBlocked ? AppColors.errorSurface : AppColors.primarySurface,
                      shape: BoxShape.circle,
                    ),
                    child: Icon(
                      isBlocked ? Icons.block_rounded : Icons.mark_email_read_rounded,
  ...
  Widget _validationAlert({required bool isError, required String title, required String message}) {
    ...
    return Container(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(isError ? Icons.error_outline_rounded : Icons.warning_amber_rounded, color: color, size: 20),
          const SizedBox(width: 10),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Text(message, style: const TextStyle(fontSize: 11, color: AppColors.textPrimary)),
              ],
            ),
          ),
        ],
