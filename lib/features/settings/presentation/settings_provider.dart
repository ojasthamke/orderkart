...
class SettingsNotifier extends StateNotifier<AsyncValue<AppSettings>> {
  ...
  Future<void> update(AppSettings settings) async {
    ...
    await _dao.setValue(
        AppConstants.keySmartRounding, settings.smartRounding.toString());
    ...
    await _dao.setValue(AppConstants.keyNotifications,
        settings.notificationsEnabled.toString());
    await _dao.setValue(
        AppConstants.keyLowStockAlert, settings.lowStockAlert.toString());
    await _dao.setValue(
        AppConstants.keyPendingAlert, settings.pendingAlert.toString());
    await _dao.setValue(
        AppConstants.keyBackupReminder, settings.backupReminder.toString());
    ...
    await _dao.setValue(AppConstants.keyLastDeliveryCharge,
        settings.lastDeliveryCharge.toString());
    await _dao.setValue(AppConstants.keyNotifTime, settings.notificationTime);
    await _dao.setValue(AppConstants.keyEnableVipPriceMarkup,
        settings.enableVipPriceMarkup.toString());
    await _dao.setValue(AppConstants.keyLanguage, settings.language);
    await _dao.setValue(AppConstants.keyWorkerDiscountCap,
        settings.workerDiscountCap.toString());
    await _dao.setValue(
        AppConstants.keyNotifSound, settings.notificationSound.toString());
    await _dao.setValue(AppConstants.keyNotifVibration,
        settings.notificationVibration.toString());
